    ...
    <>
      ...
      <Box rounded="lg" bg="#7979793b" m="2" p={2}>
        ...
        <Text color="white" pl="4" w={400}>
          Kineto Films specialized in high quality video, content marketing and
          storytelling. It helped its clients grow and thrive in a social media
          connected world.
        </Text>
      </Box>
      <Box rounded="lg" bg="#7979793b" m="2" p={4}>
        ...
        <Container pl="4" w={500}>
          Created complex kinematic assemblies of rotomolding machines. Designed
          a new production line that included oversight for the entire project.
          Managed multiple projects for instance a factory-wide IoT system, with
          custom hardware and sensors to gain unique production insight.
        </Container>
      </Box>
    </>
  );
